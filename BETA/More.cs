...
namespace ZLP_Ryze
{
    public class More
    {
        ...
        public static void Combo()
        {
            ...
            if (TargetE != null)
            {
                HitE = Spells.E.IsReady() ? EntityManager.Enemies.Where(e => e.IsValidTarget(Spells.E.Range))
                                            .OrderBy(e => e.Distance(TargetE.Position)).FirstOrDefault() : null;
                HasE = Spells.E.IsReady() ? EntityManager.Enemies.Where(e => e.IsValidTarget(Spells.E.Range) && e.HasBuff("RyzeE"))
                                            .OrderBy(e => e.Distance(TargetE.Position)).FirstOrDefault() : null;
                DieE = Spells.E.IsReady() ? EntityManager.Enemies
        ...
        public static void Lane()
        {
            ...
            if (TargetE == null)
            {
                HitE = Spells.E.IsReady() ? EntityManager.MinionsAndMonsters.EnemyMinions
                                            .Where(m => m.IsValidTarget(Spells.E.Range))
                                            .OrderBy(m => m.MaxHealth).LastOrDefault() : null;
                HasE = Spells.E.IsReady() ? EntityManager.MinionsAndMonsters.EnemyMinions
                                            .Where(m => m.IsValidTarget(Spells.E.Range) && m.HasBuff("RyzeE"))
                                            .OrderBy(m => m.MaxHealth).LastOrDefault() : null;
                DieE = Spells.E.IsReady() ? EntityManager.MinionsAndMonsters.EnemyMinions
            ...
            else
            {
                HitE = Spells.E.IsReady() ? EntityManager.MinionsAndMonsters.EnemyMinions
                                            .Where(m => m.IsValidTarget(Spells.E.Range))
                                            .OrderBy(m => m.Distance(TargetE.Position)).FirstOrDefault() : null;
                HasE = Spells.E.IsReady() ? EntityManager.MinionsAndMonsters.EnemyMinions
                                            .Where(m => m.IsValidTarget(Spells.E.Range) && m.HasBuff("RyzeE"))
                                            .OrderBy(m => m.Distance(TargetE.Position)).FirstOrDefault() : null;
                DieE = Spells.E.IsReady() ? EntityManager.MinionsAndMonsters.EnemyMinions
        ...
        public static void Jungle()
        {
            ...
            HitE = Spells.E.IsReady() ? EntityManager.MinionsAndMonsters.Monsters
                                        .Where(m => m.IsValidTarget(Spells.E.Range))
                                        .OrderBy(m => m.MaxHealth).LastOrDefault() : null;
            HasE = Spells.E.IsReady() ? EntityManager.MinionsAndMonsters.Monsters
                                        .Where(m => m.IsValidTarget(Spells.E.Range) && m.HasBuff("RyzeE"))
                                        .OrderBy(m => m.MaxHealth).LastOrDefault() : null;
            DieE = Spells.E.IsReady() ? EntityManager.MinionsAndMonsters.Monsters
                                        .Where(m => m.IsValidTarget(Spells.E.Range) && m.Health <= Spells.E.GetSpellDamage(m))
                                        .OrderBy(m => m.MaxHealth).LastOrDefault() : null;
        }
        ...
        public static void OnCast(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            ...
            if (sender.IsMe && args.Slot == SpellSlot.E && args.Target is Obj_AI_Minion)
            {
                ...
                Core.DelayAction(delegate { StopQ = false; }, 1000);
            }
        }
